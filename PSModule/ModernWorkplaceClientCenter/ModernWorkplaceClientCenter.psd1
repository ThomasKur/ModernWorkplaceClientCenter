...
FunctionsToExport = 'Get-BCStatusDetailed', 'Get-DsRegStatus', 'Get-MDMDeviceOwnership', 
               ...
               'Invoke-AnalyzeMDMEnrollmentStatus', 'Invoke-IntuneCleanup', 
               'Invoke-TestAutopilotNetworkEndpoint', 'Reset-MDMEnrollmentStatus'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = ' 0.1.14 - Adding Invoke-TestAutopilotNetworkEndpoints and Invoke-IntuneCleanup
